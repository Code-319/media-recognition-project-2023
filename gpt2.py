...
if __name__ == "__main__":
    query = "If left front bin is gray, left back bin is green, right front bin is blue, right back bin is red, select the green object from the scene to the red bin and select the black object to the blue bin"
