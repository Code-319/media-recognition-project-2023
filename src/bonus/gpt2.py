...
if __name__ == "__main__":
    query = "If left front bin is gray, left back bin is green, right front bin is blue, right back bin is red, select three apples from the scene to different bins"
