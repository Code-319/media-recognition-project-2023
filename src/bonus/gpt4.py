        ...
        [
            {
                ...
                Q: If left front bin is gray, left back bin is green, right front bin is blue, right back bin is red, I want to take some pictures so I want to select a object into the red bin.
                A: camera,right back
                Q: If left front bin is gray, left back bin is green, right front bin is blue, right back bin is red, I want to know the time so I want to select a object into the red bin.
                A: clock,right back
                Q: If left front bin is gray, left back bin is green, right front bin is blue, right back bin is red, I am cold so I want to select a object into the red bin.
                A: clothes,right back
...
if __name__ == "__main__":
    query = "If left front bin is gray, left back bin is green, right front bin is blue, right back bin is red, select the camera to the blue bin."
